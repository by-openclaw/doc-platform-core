...
| R-22 | vmbrMGMT + nic4 (enx0060dd44ecce) still active on srv-proxmox-poc-01 — live link to Arista prod fabric VLAN 600. Risk of PoC traffic injection into prod broadcast control plane. | High | Critical | 🔴 Critical | Rename bridge per VLAN plan + disable bridge + disable nic4 port before terraform apply. Manual step on Proxmox host. Decision: @yboujraf 2026-04-01. | Infra | Open |

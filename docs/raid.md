...
| I-27 | vmbrOOB break-glass bridge not yet created on srv-proxmox-poc-01 | Medium | 2026-04-03 | Create vmbrOOB: isolated, no IP, no uplink, emergency console access only. Step 4 of bridge redesign (approved by @yboujraf 2026-04-03). See platform-setup#77. | Open |
| I-17 | Terraform scaffold incomplete — OPNsense VM not deployed; vmbrPOC removed (2026-04-03, not in ADR); PoC VMs on vmbrWAN3 (OOB path, temp) | High | 2026-03-28 | Deploy OPNsense VM. Use SDN VNet bridge for LAN (not vmbrPOC). Move all PoC VMs to SDN subnets post-OPNsense. See platform-setup#58. | Open |

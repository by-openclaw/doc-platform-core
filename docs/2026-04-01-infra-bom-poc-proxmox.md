...
| **HashiCorp Vault** | Community | BUSL-1.1 | **BSL since Aug 2023.** Free for internal use + non-competing products. Missing vs Enterprise: Namespaces, HSM auto-unseal, DR replication, Secrets Sync, SAML auth, FIPS 140-2, Sentinel, Transform secrets engine. Core secrets management fully functional. | ✅ Full fit for PoC. Note BSL for prod compliance review. |

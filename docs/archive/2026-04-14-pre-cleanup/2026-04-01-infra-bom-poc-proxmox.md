...
| vm-pihole-poc-01 | Pi-hole v6 | <https://github.com/pi-hole/pi-hole> · <https://pi-hole.net> | `pihole/pihole:2025.03.0` |
| vm-traefik-poc-01 | Traefik v3 | <https://github.com/traefik/traefik> · <https://traefik.io> | `traefik:v3` |
| vm-vault-poc-01 | HashiCorp Vault | <https://github.com/hashicorp/vault> · <https://developer.hashicorp.com/vault> | `hashicorp/vault:1.19.0` |
| vm-vaultwarden-poc-01 | Vaultwarden | <https://github.com/dani-garcia/vaultwarden> | `vaultwarden/server:1.33.2-alpine` |
| vm-authentik-poc-01 | Authentik | <https://github.com/goauthentik/authentik> · <https://goauthentik.io> | `ghcr.io/goauthentik/server:2025.2.4` |
| vm-gitlab-poc-01 | GitLab CE | <https://gitlab.com/gitlab-org/gitlab> · <https://about.gitlab.com/install/> | `gitlab/gitlab-ce:17.10.1-ce.0` |
| vm-gitlab-runner-poc-01 | GitLab Runner | <https://gitlab.com/gitlab-org/gitlab-runner> | `gitlab/gitlab-runner:alpine-v17.10.1` |
| vm-nextcloud-poc-01 | Nextcloud | <https://github.com/nextcloud/server> · <https://nextcloud.com> | `nextcloud:31.0.4-fpm-alpine` |
| vm-netbox-poc-01 | NetBox | <https://github.com/netbox-community/netbox> · <https://netbox.dev> | `ghcr.io/netbox-community/netbox:v4.2.6` |
| vm-nexus-poc-01 | Nexus OSS | <https://github.com/sonatype/nexus-public> · <https://www.sonatype.com/products/sonatype-nexus-oss> | `sonatype/nexus3:3.79.0` |
| vm-observability-poc-01 | Prometheus | <https://github.com/prometheus/prometheus> | `prom/prometheus:v3.2.1` |
| vm-observability-poc-01 | Grafana | <https://github.com/grafana/grafana> | `grafana/grafana:11.5.2` |
| vm-observability-poc-01 | Loki | <https://github.com/grafana/loki> | `grafana/loki:3.4.2` |
| vm-postgres-poc-01 | PostgreSQL 16 | <https://github.com/postgres/postgres> | `postgres:16.8-alpine` |
| vm-redis-poc-01 | Redis ≤7.2 (BSD-3) | <https://github.com/redis/redis> | `redis:7.2.7-alpine` ⚠️ pin — do not upgrade to 7.4+ (RSALv2/SSPL) |
| vm-unifi-poc-01 | Unifi Network App | <https://github.com/linuxserver/docker-unifi-network-application> | `lscr.io/linuxserver/unifi-network-application:9.0.114` |
...
| **HashiCorp Vault** | Community | BUSL-1.1 | **BUSL-1.1 since Aug 2023.** Free for internal use + non-competing products. Missing vs Enterprise: Namespaces, HSM auto-unseal, DR replication, Secrets Sync, SAML auth, FIPS 140-2, Sentinel, Transform secrets engine. Core secrets management fully functional. | ✅ Full fit for PoC. Note BUSL-1.1 for prod compliance review. |
...
- **Vault BSL:** review BUSL-1.1 terms before production deployment in customer-facing context. Internal use is unambiguously permitted.
...
| **340** | `storage` | 10.1.4.0/24 | **RESERVED / NOT USED** - NAS NFS is host-level only (`poc-iso`, `poc-backup`). VMs never mount NFS directly. 340 has no current use case. Remove from Arista trunk allowed list until repurposed. | None |
| **350** | `backup` | 10.1.5.0/24 | **RESERVED / NOT USED** - same rationale as 340. No VM-level backup network needed. Proxmox backup jobs use host-level NFS directly. | None |
| **400** | `wifi` | 10.1.6.0/24 | WIFI - Unifi AP users | None |
| **410** | `users` | 10.1.7.0/24 | USERS - workstations (future) | None |
